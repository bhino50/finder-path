FinderPath — Install & First Launch
===================================
...
3. IN-APP SETUP
   ...
   anytime from the menu bar icon → Setup Guide…

4. FINDER PERMISSION
   When prompted, allow FinderPath to control Finder. This is required to read
   the current folder path. Terminal permission appears later if you use
   Terminal-backed actions.

5. MENU BAR
   FinderPath lives in the menu bar only (no Dock icon). Look for the folder
   icon near the clock.

Need help? https://github.com/bhino50/finder-path
